...
local geometry = require "mj.geometry.internal"

--- mj.geometry.rotateccw(point, aroundpoint, ntimes = 1) -> point
--- Function
...
--- mj.geometry.hypot(point) -> number
--- Function
